...
namespace Randomizer.Randomizers.Game1.TextureAssets.LE1
{
    public static class LE1Textures
    {
        ...
        public static void BuildPremadeTFC()
        {
            ...
            var premadePackageF = @"B:\UserProfile\source\repos\ME2Randomizer\Randomizer\Randomizers\Game1\Assets\Binary\Packages\LE1\Textures\PremadeImages.pcc";
            using var premadePackage = MEPackageHandler.CreateAndOpenPackage(premadePackageF, MEGame.LE2);

            var premadeTfcPath = $@"B:\UserProfile\source\repos\ME2Randomizer\Randomizer\Randomizers\Game1\Assets\Binary\Textures\{PremadeTFCName}.tfc";
        ...
        /// DO NOT CHANGE
        /// </summary>
        public const string PremadeTFCName = @"Textures_DLC_MOD_LE1Randomizer_PM";

        public static void SetupLE1Textures(GameTarget target)
        {
