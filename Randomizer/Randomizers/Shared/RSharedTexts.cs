...
namespace Randomizer.Randomizers.Shared
{
    class RSharedTexts
    {
        ...
        /// <summary>
        /// Randomizes the opening crawl string.
        /// </summary>
        ...
        {
            string fileContents = MEREmbedded.GetEmbeddedTextAsset("openingcrawls.xml");
...
#if __GAME1__
            // Only has one instance of the intro
            TLKBuilder.ReplaceString(153106, TrimForIntro(gameoverTexts.RandomElement().Trim()));
#elif __GAME2__
            // Three different backstories
            TLKBuilder.ReplaceString(331765, TrimForIntro(gameoverTexts.RandomElement().Trim()));
        ...
        /// <summary>
        /// Randomizes the CRITICAL MISSION FAILURE text when you die
        /// </summary>
        /// <param name="target"></param>
        /// <param name="arg"></param>
        /// <returns></returns>
        public static bool RandomizeGameOverText(GameTarget target, RandomizationOption arg)
        {
            ...
            TLKBuilder.ReplaceString(157152, gameOverText);
            return true;
        }
        ...
        private static string AddReactionToLine(string vanillaLine, string modifiedLine, bool keepCasing)
        {
            ...
            {
                string rawReactionDefinitions = MEREmbedded.GetEmbeddedTextAsset("reactiondefinitions.xml");
        ...
        public static bool RandomizeVowels(GameTarget target, RandomizationOption option)
        {
            ...
            var nonMERTLKs = TLKBuilder.GetAllTLKs().Where(x => !MERTLKs.Contains(x)).ToList();
            // MER
